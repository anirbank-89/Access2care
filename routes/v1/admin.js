...
const MEDICATION_PRACTICES = require('../../controllers/admin/risk_assessment/MedicationPractice');
...
router.get('/survey', ABOUT_US_INFO.viewAllsurvey);
...
router.post('/medication-usage', MEDICATION_PRACTICES.addPractice);
